...
export function TrashZone({ isDragging }: { isDragging: boolean }) {
  ...
  return (
    <div
      ref={setNodeRef}
      className={`hidden md:flex fixed bottom-6 left-1/2 -translate-x-1/2 z-40 px-8 py-3.5 rounded-md border-2 border-dashed items-center gap-3 transition-all duration-200 shadow-2xl backdrop-blur-md select-none ${
        isOver
